...
{
    public $mark = null;
    public $barcenter = false;
    protected $filled = false;
    protected $fill_color = 'blue';
    protected $step_style = false, $center = false; // Default to solid
    protected $line_style = 1; // array of arrays(with min,max,col,filled in them)
    protected $filledAreas = array();  // When we mix line and bar. Should we center the line in the bar.
