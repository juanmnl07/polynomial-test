...
class PiePlot
{
    ...
    protected $radius = 0.3;  // Array of targets for CSIM
    protected $explode_radius = array(), $explode_all = false, $explode_r = 20;  // Generated CSIM text
    protected $labels = null, $legends = null;  // ALT tags for corresponding target
    protected $csimtargets = null, $csimwintargets = null;
    protected $csimareas = '';
    ...
    protected $themearr = array(
        ...
        "sand" => array(27, 168, 34, 170, 19, 50, 65, 72, 131, 209, 46, 393)); // Default to percentage
...
{
    public $midtitle = '';  // Fraction of total width
