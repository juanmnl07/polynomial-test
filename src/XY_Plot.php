...
require_once($RootDirectory . 'Includes/XY_Plot/ClipLine.php');
require_once($RootDirectory . 'Includes/XY_Plot/ClipCircle.php');
...
class XY_Plot
{
    ...
    public function calculateLinearRegression()
    {
        ...
        $sumX_SumX = $sumX * $sumX; // ( �x )^2
        $sumY_SumY = $sumY * $sumY; // ( �y )^2
